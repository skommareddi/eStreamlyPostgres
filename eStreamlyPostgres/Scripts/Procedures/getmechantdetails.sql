...
AS $BODY$
	...
	select p."Business_Id" BusinessId
			...
			,pr.Review
			,case when pvl."CompareAtPrice"  is not null and pvl."CompareAtPrice" > 0 and  pvl."CompareAtPrice" != pvl."Price" then pvl."Price" else COALESCE(cast (pvl."Price"  - (pvl."Price"  * d."Discount_Percentage" / 100) as decimal(10,2)),pvl."Price") end DiscountedPrice
