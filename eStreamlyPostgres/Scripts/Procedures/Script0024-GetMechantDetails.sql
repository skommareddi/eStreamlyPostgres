-- FUNCTION: public.getmechantdetails(text, refcursor, refcursor, refcursor, refcursor, refcursor)

-- DROP FUNCTION IF EXISTS public.getmechantdetails(text, refcursor, refcursor, refcursor, refcursor, refcursor);
