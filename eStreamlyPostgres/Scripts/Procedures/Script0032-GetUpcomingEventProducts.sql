CREATE OR REPLACE FUNCTION GetUpcomingEventProducts() 
    RETURNS TABLE (
         BusinessId	bigint
...
,BusinessShortName	varchar
,ProductVariantListId	bigint
,ProductVariantKey	varchar
,ProductVariantValue	varchar
,ProductVariantValue1	varchar
,Price	numeric
,rn	bigint
,CreatedDate	timestamp with time zone
,DiscountedPrice	decimal
,IsDiscountAvailable	int
,DiscountPercentage	numeric
,DesktopImageUrl	varchar
,TabletImageUrl	varchar
,MobileImageUrl	varchar
,ProductSortDate	timestamp with time zone)
    LANGUAGE plpgsql  AS $$
	DECLARE 
     BEGIN
