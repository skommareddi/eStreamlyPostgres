...
CREATE TABLE IF NOT EXISTS public."WC_Product"
(
    ...
    CONSTRAINT pk_wc_product PRIMARY KEY ("Product_Id"),
    CONSTRAINT wcproduct_fk_businessid FOREIGN KEY ("Business_Id")
...
CREATE INDEX IF NOT EXISTS "PK_WC_Product"
    ON public."WC_Product" USING btree
