-- Table: public.MediaByUserAndChannel

-- DROP TABLE IF EXISTS public."MediaByUserAndChannel";
...
(
    ...
    "Uploaded_Event_Thumbnail_Image_Url" character varying COLLATE pg_catalog."default",
    "Is_Active" boolean,
...
-- Index: Media_Unique_Id

-- DROP INDEX IF EXISTS public."Media_Unique_Id";
...
-- Index: PK_MediaByUserAndChannel

-- DROP INDEX IF EXISTS public."PK_MediaByUserAndChannel";
