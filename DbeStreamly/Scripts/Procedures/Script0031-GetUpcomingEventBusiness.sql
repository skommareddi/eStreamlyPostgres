CREATE OR REPLACE FUNCTION public.getupcomingeventbusiness(
    ...
    RETURNS TABLE(businessname character varying, businessimage character varying, shortname character varying, backgroundimage character varying, followerscount numeric, businessid bigint) 
    LANGUAGE 'plpgsql'
    COST 100
