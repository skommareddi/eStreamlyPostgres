-- Table: public.Video_Interactivity

-- DROP TABLE IF EXISTS public."Video_Interactivity";
...
(
    ...
    CONSTRAINT video_interactivity_fk_channelinfoid FOREIGN KEY ("Channel_Info_Id")
...
-- Index: PK_Video_Interactivity

-- DROP INDEX IF EXISTS public."PK_Video_Interactivity";
