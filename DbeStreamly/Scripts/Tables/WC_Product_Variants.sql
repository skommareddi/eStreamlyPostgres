...
CREATE TABLE IF NOT EXISTS public."WC_Product_Variants"
(
    ...
    "WC_Product_Variant_Id" bigint NOT NULL,
    ...
    CONSTRAINT pk_wc_product_variants PRIMARY KEY ("Product_Variant_Id"),
    CONSTRAINT wcproductvariant_fk_productid FOREIGN KEY ("Product_Id")
...
CREATE INDEX IF NOT EXISTS "PK_WC_Product_Variants"
    ON public."WC_Product_Variants" USING btree
