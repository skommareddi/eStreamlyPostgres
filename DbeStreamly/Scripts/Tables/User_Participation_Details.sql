-- Table: public.User_Participation_Details

-- DROP TABLE IF EXISTS public."User_Participation_Details";
...
-- Index: PK_User_Participation_Details

-- DROP INDEX IF EXISTS public."PK_User_Participation_Details";
